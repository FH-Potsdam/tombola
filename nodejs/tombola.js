...
// var list = ["Duffy Duck","Bart Simpson","Bender Bending Rodríguez",
// "Gabriel García Márquez","Massimo Banzi","J. Johna Jameson"];
//
...
fs.writeFileSync('result.txt', res.join('\n'), 'UTF-8', {
  flags: 'w+'
});
